...
- **Status:** Layers 1+2+3c+3d+3e done; Layer 3a-i partial (Jobs card migrated, pending revert in Phase 1 Layer 8e); Layer 4 + Phase 1 (8a-8f) not started. Phase 1 prerequisites (Layer 3e + Item 15g Layer 15g-ii) now both landed — Phase 1 unblocked.
