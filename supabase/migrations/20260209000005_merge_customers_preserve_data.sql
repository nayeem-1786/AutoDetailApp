-- Add mobile_2 column and replace merge_customers() to preserve data from merged records.

-- 1. Add mobile_2 column
ALTER TABLE customers ADD COLUMN IF NOT EXISTS mobile_2 TEXT;

-- 2. Replace merge_customers() with data-preserving version
...
BEGIN
  ...
  -- Apply backfilled data to kept customer (before reassigning FKs)
