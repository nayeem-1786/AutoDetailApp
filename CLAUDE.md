...
- Sticky ticker: header + ticker wrapped in single `sticky top-0 z-50` container. Ticker renders below header and stays pinned while scrolling. Removed sticky from `<header>` element itself.
