    ...
    input_schema: {
      ...
      properties: {
        ...
        confirm_resend: {
          type: 'boolean',
          description:
            "OPTIONAL. Set to true ONLY when retrying after receiving a 409 + code='previous_link_paid' response AND the customer has explicitly confirmed they want a NEW payment link. Without explicit customer confirmation, do NOT pass this — let the conversational flow play out first. Default is false.",
        },
      },
