...
export type PaymentMethod = 'cash' | 'card' | 'check' | 'split' | 'digital';
...
export type StockAdjustmentType = 'manual' | 'received' | 'sold' | 'returned' | 'damaged' | 'recount' | 'shop_use' | 'customer_retained' | 'voided';
...
export type AuditEntityType = 'customer' | 'transaction' | 'order' | 'coupon' | 'booking' | 'product' | 'service' | 'employee' | 'settings' | 'campaign' | 'job' | 'quote' | 'customer_credit' | 'appointment';
