...
export const serviceCreateSchema = z.object({
  ...
  exotic_floor_price: positiveNumber.optional().nullable(),
  classic_floor_price: positiveNumber.optional().nullable(),
  is_active: z.boolean().default(true),
...
export const campaignCreateSchema = z.object({
  ...
  email_body_blocks: z.array(z.record(z.string(), z.unknown())).optional().nullable(),
  email_layout_id: z.string().uuid().optional().nullable(),
  email_preview_text: optionalString,
  coupon_id: z.string().uuid().optional().nullable(),
