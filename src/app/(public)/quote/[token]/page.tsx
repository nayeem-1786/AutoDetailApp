...
export default async function PublicQuotePage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:py-12">
      ...
      {/* Status Banners */}
      {isExpired && (
        <div className="mb-6 rounded-lg border border-red-800 bg-red-950 px-6 py-4">
          <p className="text-sm font-medium text-red-200">This quote has expired.</p>
      ...
      {isAccepted && (
        <div className="mb-6 rounded-lg border border-green-800 bg-green-950 px-6 py-4">
      ...
      {isConverted && (
        <div className="mb-6 rounded-lg border border-purple-800 bg-purple-950 px-6 py-4">
