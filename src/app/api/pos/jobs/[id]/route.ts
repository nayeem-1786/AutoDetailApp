...
const JOB_SELECT = `
  *,
  ...
  appointment:appointments!jobs_appointment_id_fkey(id, status, payment_status, total_amount, channel, is_mobile, mobile_address, mobile_surcharge, mobile_zone_name_snapshot),
  addons:job_addons(*)
`;
