...
/**
 * UUID v4 generator with crypto.randomUUID fallback for older Safari/iPad.
 * Duplicated from the reducers' local `generateId` for now — C.1 step 2
 * (ADD_PRODUCT extraction) will relocate this to a shared utility once
