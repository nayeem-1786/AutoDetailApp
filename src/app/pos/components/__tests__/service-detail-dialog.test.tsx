...
describe('ServiceDetailDialog — tier disable logic (Session 29)', () => {
  ...
  it('scope-model tiers with custom names: none disabled', () => {
    const scopeTiers = [
      mockTier({ tier_name: 'complete_interior', tier_label: 'Complete Interior', price: 200, display_order: 0 }),
      mockTier({ tier_name: 'floor_mats', tier_label: 'Floor Mats Only', price: 80, display_order: 1 }),
    ];
    render(
      <ServiceDetailDialog
