...
export function ProductCategoryCard({ category, productCount }: ProductCategoryCardProps) {
  return (
    <Link href={`/products/${category.slug}`} className="group block">
      <div className="h-full rounded-2xl bg-brand-surface p-6 border border-site-border transition-all duration-300 hover:border-lime/30 hover:-translate-y-1 hover:shadow-lime-sm">
        <div className="flex items-start justify-between">
          ...
          <div className="ml-4 flex-shrink-0 text-site-text-muted group-hover:text-lime transition-colors">
