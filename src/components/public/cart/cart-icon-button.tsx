...
export function CartIconButton() {
  ...
  return (
    ...
    >
      <ShoppingBag className="h-5 w-5" />
      {itemCount > 0 && (
        <span className="absolute -top-0.5 -right-0.5 flex h-4.5 min-w-4.5 items-center justify-center rounded-full bg-accent-brand px-1 text-[10px] font-bold text-site-text-on-primary animate-in zoom-in duration-200">
